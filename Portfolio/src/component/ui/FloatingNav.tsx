      ...
      >
        {/* {navItems.map((navItem: any, idx: number) => ( */}
          ...
          >
            {/* <span className="block sm:hidden">{navItem.icon}</span> */}
            {/* <span className="block sm:hidden">{navItem.icon}</span> */}
            <span className="hidden sm:block text-sm">Special Offers</span>
            {/* <span className="hidden sm:block text-sm">{navItem.name}</span> */}
          </a>
          <a
            // key={`link=${idx}`}
          ...
          >
            {/* <span className="block sm:hidden">{navItem.icon}</span> */}
            {/* <span className="block sm:hidden">{navItem.icon}</span> */}
            <span className="hidden sm:block text-sm">Resturant</span>
            {/* <span className="hidden sm:block text-sm">{navItem.name}</span> */}
          </a>
          <a
            // key={`link=${idx}`}
          ...
          >
            {/* <span className="block sm:hidden">{navItem.icon}</span> */}
            {/* <span className="block sm:hidden">{navItem.icon}</span> */}
            <span className="hidden sm:block text-sm">Track Order</span>
            {/* <span className="hidden sm:block text-sm">{navItem.name}</span> */}
          </a>
        {/* ))} */}
