...
{/* <div className="relative flex flex-col md:flex-row gap-2 container justify-around mx-auto text-[#F5F5F5] md:w-[40%] max-lg:w-[40%]">
  <div className="flex flex-col bg-[#F5F5F5] mx-4 mr-1.5 items-start max-lg:py-4 p-2 rounded-md">
  ...
  <div className="bg-[#F5F5F5] px-2 md:w-[40%] max-lg:w-[40%] ml-4 pb-2 rounded-md">
    <form
      action=""
      id="contactForm"
